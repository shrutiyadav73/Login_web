        ...
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
          <Block title="Simple" sx={style}>
            <Button
              variant="contained"
              color="inherit"
              onClick={() => window.Toast('This is an default', { variant: 'default' })}
            >
              Default
            </Button>
            <Button
              variant="contained"
              color="info"
              onClick={() => window.Toast('This is an info', { variant: 'info' })}
            >
              Info
            </Button>
            <Button
              variant="contained"
              color="success"
              onClick={() => window.Toast('This is an success', {})}
            >
              Success
            </Button>
            <Button
              ...
              color="warning"
              onClick={() =>
                window.Toast('This is an warning', {
                  variant: 'warning',
                })
              }
            >
            ...
            <Button
              variant="contained"
              color="error"
              onClick={() => window.Toast('This is an error', { variant: 'error' })}
            >
              Error
            </Button>
          </Block>
          ...
          <Block title="With Close" sx={style}>
            <Button
              ...
              color="inherit"
              onClick={() =>
                window.Toast('This is an default', {
                  variant: 'default',
                })
              }
            >
            ...
            <Button
              ...
              color="success"
              onClick={() =>
                window.Toast('This is an success', {
                  variant: 'success',
                })
              }
            >
            ...
            <Button
              ...
              color="error"
              onClick={() =>
                window.ToastError('This is an error', {
                  variant: 'error',
                })
              }
            >
