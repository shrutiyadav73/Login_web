...
// _mock_
// components
import ManufacturerTableRow from "src/sections/@dashboard/resources/manufacturer/list/manufacturerTableRow";
import ManufacturerTableToolbar from "src/sections/@dashboard/resources/manufacturer/list/manufacturerTableToolbar";
...
let TABLE_HEAD = [
  { id: "name", label: "Manufacturer Name", align: "left" },
  { id: "status", label: "Status", align: "left" },
];
if (
  window.checkPermission("resources.manufacturer.update") ||
  window.checkPermission("resources.manufacturer.delete") ||
...
export default function ManufacturerListPage() {
  ...
  return (
    <ViewGuard permission="resources.manufacturer.read" page={true}>
      <Helmet>
